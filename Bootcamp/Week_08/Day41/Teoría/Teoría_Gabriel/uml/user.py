...
class Administrator(User):
    ...
    def __init__(self, userId, password, loginStatus, registerDate, aN, em):
        ...
        self.adminName = aN # Ojo normalmente sería adminName en vez de aN. Solo está puesto así para entenderlo
        self.email = em # Ojo normalmente sería email en vez de em. Solo está puesto así para entenderlo
